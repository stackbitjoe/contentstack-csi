 ...
 */
const components = {
    CarouselSection: dynamic(() => import('./sections/CarouselSection'), { ssr: false }),
    ...
    'featured_people_section': dynamic(() => import('./sections/FeaturedPeopleSection')),
    // 'sections.divider-section': dynamic(() => import('./sections/DividerSection')),
    'generic_section': dynamic(() => import('./sections/GenericSection')),
    'carousel_section': dynamic(() => import('./sections/CarouselSection'), { ssr: false }),
};
